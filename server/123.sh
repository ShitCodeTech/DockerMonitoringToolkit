...
# repo_url="https://github.com/ShitCodeTech/DockerMonitoringToolkit"
...
start_command="docker run -p 8080:8080 server_monitor"
...
if [[ -f /etc/os-release ]]; then
    ...
    export ID=$HOST_ID
    export PRETTY_NAME=$HOST_PRETTY_NAME
else
...
echo "Starting start command: $sdjfkd"
$start_command
